    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, validators=[django.core.validators.RegexValidator(code='invalid_username', message='الاسم يجب ان يتكون من احرف و ارقام', regex='^[\\w.@+\\- ]+$')])),
